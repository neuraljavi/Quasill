...
from website.logic import create_diagnostic, read_all_diagnostics, read_diagnostic, proportionate_feedback, delete_diagnostic
...
@auth.route('/diagnostics', methods=['POST'])
def diagnosticate():
    user_id = session.get('user_id')
